...
date: last-modified
date-format: long
output-file: template-revealjs.html
bibliography: references.bib
csl: _extensions/aagi/assets/biometrics.csl

title: "AAGI Demonstration Presentation"
author:
  - name: "Adam Sparks"
...
# Thank You {background-image="_extensions/aagi/assets/title-slide-main.png" background-size="1050px auto" background-position="50% 85%"}
