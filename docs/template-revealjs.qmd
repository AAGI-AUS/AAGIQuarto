...
# Inherit params$uni and params$uni_info from _quarto.yml.
# If you want to override the university for *this* deck only, uncomment:
# params:
#   uni: AU

title: "`r sprintf('AAGI – %s', params$uni_info[[params$uni]]$name)`"
author:
  - name: "Adam Sparks"
...
# Centralised setup: installs (optionally), sets themes/devices, exports uni_name
source("_scripts/setup.R", local = TRUE)

# Slide-deck-specific libraries (install handled by setup.R when AAGI_AUTO_INSTALL=true)
