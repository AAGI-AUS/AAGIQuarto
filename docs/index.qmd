...
- **AAGI PDF Short Report:** [AAGI PDF Short Report Demo](https://aagi-aus.github.io/AAGIQuarto/demos/template-pdf-short-report.pdf) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-pdf-report.qmd))

- **AAGI PDF Report:** [AAGI PDF Report Demo](https://aagi-aus.github.io/AAGIQuarto/demos/template-pdf-report.pdf) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-pdf-report.qmd))
...
- **AAGI HTML Document Report:** [AAGI HTML Document Demo](https://aagi-aus.github.io/AAGIQuarto/demos/template-html-report.html) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-html-report.qmd))

- **AAGI HTML Document Short Report:** [AAGI HTML Document Short Demo](demos/template-html-short-report.html) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/demos/template-html-short-report.qmd))
...
- `aagi-html-report`, for a full length HTML report
- `aagi-html-short-report`, for a short HTML report
