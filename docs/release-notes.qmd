...
* Updates the strategic partner logo block.

## Bug fixes 

* Fixes links in README to example output files, these were working from the Quarto website but no from the README.

# 1.0.0  2026-04-07

## Major changes 

* Adds long and short HTML format reports.
...
* Ensures that "AU" and "Adelaide University" are used in the documents.
