...
* HTML templates and revealjs slides are now self-contained, you can share just the HTML file and all CSS, images and other assets are included in that file. 
  No subdirectories are necessary.
...
* Adds code blocks to PDF outputs, thank you for the PR, [\@William-Pincombe](https://github.com/William-Pincombe).
