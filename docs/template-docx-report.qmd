...
params:
  uni: CU
  Pro_Num: ABC2026-001RTX
  university: !expr if (params$uni == "CU") "Curtin University" else if (params$uni == "UA") "University of Adelaide" else "University of Queensland"
title: "Analytics for the Australian Grains Industry - `r params$university` (AAGI-`r params$uni`) Technical Report Series: 123"
