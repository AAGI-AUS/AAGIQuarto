...
title: !expr paste(
  ...
  sprintf("(AAGI-%s) Technical Report Series: 123", params$uni)
)
...
author:
  ...
  - !expr paste("Project Lead:",
      if (params$uni == "CU") "Curtin University -- Prof Mark Gibberd, A/Prof Julia Easton, Prof Adam Sparks"
      else if (params$uni == "UA") "University of Adelaide -- A/Prof Julian Taylor, Dr Olena Kravchuck"
...
#| include: false
if (params$uni == "CU") {
  project_lead = "Curtin University -- Prof Mark Gibberd, A/Prof Julia Easton, Prof Adam Sparks"
} else if (params$uni == "UA") {
  project_lead = "University of Adelaide -- A/Prof Julian Taylor, Dr Olena Kravchuck"
} else {
