...
title: !expr paste("Analytics for the Australian Grains Industry -", params$university, sprintf("(AAGI-%s) Technical Report Series: 123", names(params$university)))
subtitle: !expr paste0(params$report_title, "\nReport for ", params$project_num)
author:
