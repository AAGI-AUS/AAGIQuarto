...
- **AAGI HTML Document Report:** [AAGI HTML Document Demo](https://aagi-aus.github.io/AAGIQuarto/assets/template-html-report.html) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/template-html-report.qmd))
- **AAGI HTML Document Short Report:** [AAGI HTML Document Short Demo](https://aagi-aus.github.io/AAGIQuarto/assets/template-html-short-report.html) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/template-html-short-report.qmd))

### Presentation Formats

- **AAGI revealjs Presentation:** [AAGI revealjs Slide Demo](https://aagi-aus.github.io/AAGIQuarto/assets/template-revealjs.html#/title-slide) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/template-revealjs.qmd)) (this is an `AAGIQuarto` exclusive)

- **AAGI PowerPoint Presentation:** [AAGI PPT Slide Demo](https://aagi-aus.github.io/AAGIQuarto/assets/template-pptx.pptx) ([Source](https://github.com/AAGI-AUS/AAGIQuarto/blob/main/docs/template-pptx.qmd))
